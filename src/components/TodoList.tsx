  ...
  return (
    <ul className="space-y-4 mt-8">
      {todos.map((todo) => (
        <li
          key={todo.id}
          className="flex items-center justify-between bg-white p-4 rounded-lg shadow-md border border-gray-200 transition hover:bg-gray-100"
        >
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
                ...
                className="bg-green-500 hover:bg-green-600 text-white font-bold py-1 px-2 rounded-md text-sm"
            >
                Save
            </button>
            ) : (
